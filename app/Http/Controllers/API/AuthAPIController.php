...
class AuthAPIController extends AppBaseController
{
    ...
    public function login(Request $request)
    {
        ...
        /** @var User $user */
        $user = User::whereRaw('lower(name) = ?', [$name])->first();
        if (empty($user)) {
        ...
        if (! $user->is_active) {
            return JsonResponse::fromJsonString(ResponseUtil::makeError('Your account is deactivated. Please contact your upper leve l manager for account activation.'), Response::HTTP_UNAUTHORIZED);
        }
    ...
    public function register(RegisterRequest $request)
    {
        ...
        return $this->sendSuccess('You have registered successfully, please awaiting for approval from your upper level admin');
    }
