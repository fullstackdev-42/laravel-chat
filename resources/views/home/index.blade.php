...
<section class="landing d-flex align-items-center">
    <div class="landing__illustration">
        <img src="{{ !empty(getFrontCmsImage('landing_image')) ? getFrontCmsImage('landing_image') : asset('assets\images\epps_image.png')}}"
             alt="">
    </div>
    <div class="container">
        <div class="row">
            <div class="col-12 col-lg-12">
                <h1 class="landing__heading fw-bolder mb-3 d-none">{{ getAppName() }}</h1>
                <h1 class="landing__sub-heading">  {{ getFrontCmsValue('sub_heading') }}</h1>
...
<!--feature section-->
<section class="feature section-spacing-bottom  d-none">
    <div class="container">
        <div class="row">
...
<section class="feature-brief section-spacing-bottom section-spacing-top d-none">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-md-6 d-flex feature-brief__img-wrapper">
                <img src="{{ !empty(getFrontCmsImage('features_image')) ? getFrontCmsImage('features_image') : asset('assets/images/chat-landing3.jpg')}}"
                     alt="{{ __('messages.infy_chat_features') }}"
...
<!--/feature-brief-->
<!--testimonials-->
<section class="testimonials section-spacing-bottom section-spacing-top d-none">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <a href="{{ route('register') }}" class="feature-brief__list-item start-using-now__get-start-btn primary-btn btn text-white">
                            {{ __('messages.get_started') }}
                        </a>
                    </div>
                    <div class="col-12 col-lg-6 d-flex start-using-now__img-wrapper">
                        <img src="{{ !empty(getFrontCmsImage('start_chat_image')) ? getFrontCmsImage('start_chat_image') : asset('assets/images/chat-landing3.jpg')}}"
    ...
    <div class="footer__container container mt-3">
        <div class="row">
            <div class="col-md-6">
                ...
                <ul>
                    <li>
                        <a href="#" target="_blank">{{ __('messages.twitter') }}</a>
                    </li>
                    <!-- <li>
