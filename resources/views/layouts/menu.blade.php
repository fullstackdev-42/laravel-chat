...
<li class="nav-item {{ Request::is('blogs*') ? 'active' : '' }}">
    <a class="nav-link {{ Request::is('blogs*') ? 'active' : '' }}" href="{{ url('blogs')  }}">
        <i class="fa fa-picture-o nav-icon me-4"></i>
...
@role('Admin')
    <li class="nav-item {{ Request::is('centers*') ? 'active' : '' }}">
        <a class="nav-link {{ Request::is('centers*') ? 'active' : '' }}"
        href="{{ route('centers.index') }}">
            <i class="fa fa-building-o nav-icon me-4"></i>
            <span>{{ __('messages.centers') }}</span>
        </a>
    </li>
@endrole
{{-- @endif --}}
...
@can('manage_groups')
    <li class="nav-item {{ Request::is('group*') ? 'active' : '' }}">
        <a class="nav-link {{ Request::is('group*') ? 'active' : '' }}"
           href="{{ route('group.index') }}">
            <i class="fa fa-flag nav-icon me-4"></i>
            <span>{{ __('messages.group.groups') }}</span>
        </a>
    </li>
@endcan
