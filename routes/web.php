...
Route::middleware(['user.activated', 'auth'])->group(function () {
    ...
    Route::get('/blogs', [BlogController::class, 'index'])->name('blogs')->middleware('permission:manage_conversations');
    Route::post('/blogs/create-blog', [BlogController::class, 'createBlog'])->name('blogs/create-blog');
    Route::post('/blogs/delete-blog', [BlogController::class, 'deleteBlog'])->name('blogs/delete-blog');
    Route::post('/blogs/filter-blogs', [BlogController::class, 'filterBlogs'])->name('blogs/filter-blogs');
    Route::post('/blogs/expand-blogs', [BlogController::class, 'expandBlogs'])->name('blogs/expand-blogs');
...
Route::post('/password/reset', [ResetPasswordController::class, 'sendResetRequestToAdmin']);
...
Route::middleware(['permission:manage_users', 'auth', 'user.activated'])->group(function () {
    ...
    Route::post('users/{user}/approve-new-password', [UserController::class, 'approveNewPassword'])->name('approve-new-password');
...
Route::middleware(['permission:manage_centers', 'auth', 'user.activated'])->group(function () {
    Route::resource('centers', CenterController::class);
});

Route::middleware(['permission:manage_groups', 'auth', 'user.activated'])->group(function () {
...
Route::middleware('web')->group(function () {
    ...
    Route::get('get-center-groups', [CenterController::class, 'getCenterGroups'])->name('center.groups');
});
